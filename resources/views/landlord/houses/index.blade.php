    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <div>
          <!-- button -->
          <div class="mytabl">
              <a href="{{route('landlord.house.create')}}" class="btn btn-myprimary rounded-pill"> + Create New House</a>
          </div>
          <!-- table -->
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">My Houses</h3>
                  ...
                  <table class="table table-hover">
                    ...
                    @foreach ($houses as $house)
                        <tr>
                            ...
                            <td>
                              <h6 >{{$house->nameHouse}}</h6>
                          </td>
                            <td>
                                <h6 >{{$house->adresse}}</h6>
                            </td>
                            <td >
                                <h6>{{$house->HouseGender}}</h6>
                            </td>
                            <td >
                                <h6>{{$house->DistanceFac}}</h6>
                            </td>
                            <td >
                                <h6>{{$house->NomberRoom}}</h6>
                            </td>
                            <td>
