                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    ...
                    <tr>
                      ...
                      <th>House Name</th>
                      <th>Rooms number</th>
                      <th>Distance to FPO</th>
                      <th>Tenants Gender</th>
                      <th>Address</th>
                      <th>Picture</th>
                      <th>Edit</th>
                      <th>Delete</th>
                    </tr>
                    @foreach ($usersWithHouses as $user)
                    <td class="bg-primary" colspan="9">{{ $user->firstName }} {{ $user->lastName }}</td>
                    @foreach ($user->houses as $house)
                <tr>
                    <td>{{ $house->id }}</td>
                    <td>{{ $house->nameHouse }}</td>
                    <td>{{ $house->NomberRoom }}</td>
                    <td>{{ $house->DistanceFac }}</td>
                    <td>{{ $house->HouseGender }}</td>
                    <td>{{ $house->adresse }}</td>
                    <td>
