              ...
              <div class="box">
                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    ...
                    <td class="bg-primary" colspan="9">{{ $house->id }} {{ $house->nameHouse }}</td>
                ...
                <tr>
                    ...
                    <td>{{ $room->price }}</td>
                    <td>
                        <img src="{{ asset($room->Photo) }}" alt="" style="width: 70px; height: 70px">
                    </td>
                    <td>
                  ...
                  <td>
                    ...
                    <td>
                        <form action="{{ route('admin.house.delete', $house->id) }}" method="post" onsubmit="return confirm('Are you sure you want to delete this house?')">
                            @csrf
                            @method('DELETE')
